    ...
    *, claude_settings_configured: bool, has_requests: bool
    ...
    steps = [
        OnboardingStep(
            ...
            description=(
                "Add a free API key from a supported provider so FCC has a "
        ...
        OnboardingStep(
            id="client",
            label="Point Claude Code at FCC",
            description=(
                "Apply FCC's proxy settings to your Claude Code settings.json "
        ...
        OnboardingStep(
            ...
            description=(
                "Run a Claude Code command through FCC and watch it show up "
                "in the requests log."
            ),
            view="requests",
            optional=True,
        ...
        OnboardingStep(
            ...
            description="Skim the quick guide to see what FCC's dashboard can do.",
            view="guide",
            optional=True,
